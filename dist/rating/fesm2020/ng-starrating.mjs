...
RatingComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.9", ngImport: i0, type: RatingComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
RatingComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "14.2.9", type: RatingComponent, selector: "lib-rating", ngImport: i0, template: `
    <p>
      rating works!
    </p>
  `, isInline: true });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.9", ngImport: i0, type: RatingComponent, decorators: [{
            type: Component,
...
StarRatingComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.9", ngImport: i0, type: StarRatingComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
StarRatingComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "14.2.9", type: StarRatingComponent, selector: "star-rating", inputs: { checkedcolor: "checkedcolor", uncheckedcolor: "uncheckedcolor", value: "value", size: "size", readonly: "readonly", totalstars: "totalstars" }, outputs: { rate: "rate" }, viewQueries: [{ propertyName: "mainElement", first: true, predicate: ["starMain"], descendants: true, static: true }], ngImport: i0, template: "<div #starMain>\n</div>", styles: [":root{--checkedColor: gold;--unCheckedColor: gray;--size: 24px;--halfWidth: 10px;--halfMargin: -20px}.star{cursor:pointer;color:gray;color:var(--unCheckedColor);font-size:24px;font-size:var(--size);width:24px;width:var(--size);display:inline-block}.star:last-child{margin-right:0}.star:before{content:\"\\2605\"}.star.on{color:gold;color:var(--checkedColor)}.star.half:after{content:\"\\2605\";color:gold;color:var(--checkedColor);position:absolute;margin-left:-20px;margin-left:var(--halfMargin);width:10px;width:var(--halfWidth);overflow:hidden}\n"], encapsulation: i0.ViewEncapsulation.ShadowDom });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.9", ngImport: i0, type: StarRatingComponent, decorators: [{
            type: Component,
